...
<div class="card card-default">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
              <form action="<?php echo BASE_URL; ?>produto/editar/<?php echo $produto['id']; ?>" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                    <label for="inputnome">Nome</label>
                    <input type="text" name="nome" class="form-control" id="inputnome" value="<?php echo $produto['nome']; ?>" placeholder="Nome">
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="file" name="imagem" class="form-control-file" id="inputfile">
                  </div>
                </div>
                <div class="col-sm-12">
                  <div class="form-group">
