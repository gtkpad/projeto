    ...
    <div class="col-sm-3">
        <div class="card card-primary card-outline">
            <div class="card-body box-profile">
                <h3 class="profile-username text-center"><?php echo $marca['nome']; ?></h3>
    ...
    <div class="col-sm-9">
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h5 class="card-title m-0">Produtos da marca</h5>
            </div>
            <div class="card-body box-profile">
...
<?php if($this->auth->adminAuth()): ?>
    <div class="col-sm-12">
        <div class="card card-primary card-outline">
            ...
            <form method="POST" action="<?php echo BASE_URL; ?>marca/editar/<?php echo $marca['id']; ?>">
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="nome" class="form-control" id="nome" placeholder="Nome" aria-describedby="nome" value="<?php echo $marca['nome']; ?>" required>
                        </div>
                    </div>
            ...
            dataType: "html"
                ...
                Swal.fire(
                    ...
                    'success'
                        ...
                        if (result.value) {
                            window.location.href = "<?php echo BASE_URL; ?>marca/abrir/<?php echo $marca['id']; ?>";
                        }
                        })
